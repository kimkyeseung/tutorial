        ...
        <div className="rounded-lg bg-black/80 px-3 py-2 text-sm text-white">
          ...
          <div className="space-y-1 text-xs">
            <div className="flex justify-between gap-4">
              ...
              <span>
                {formatTime(videoDebugInfo.currentTime)} /{" "}
                {formatTime(videoDebugInfo.duration)}
              </span>
            </div>
            <div className="flex justify-between gap-4">
              ...
              <span>
                {videoDebugInfo.duration > 0
                  ? Math.round(
                      (videoDebugInfo.currentTime / videoDebugInfo.duration) *
                        100,
                    )
                  : 0}
                %
