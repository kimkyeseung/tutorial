...
const EntryPage: React.FC<EntryPageProps> = ({
  ...
  return (
    <div className="absolute inset-0 z-50 flex flex-col items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
      {/* 상단 버튼들 */}
      ...
      <div className="flex max-w-2xl flex-col items-center px-8">
        ...
        <p className="mt-6 text-sm text-gray-400">시작하기 버튼을 클릭하세요</p>
